...
public class InfoTree {
	...
	public boolean[][] nodeType; // store the type of a node: for every node stores three boolean
	// values (L, R,
	// H)
	...
	/**
	 * Returns relevant subtrees for given node. Assuming that child v of given node belongs to
	 * given path, all children of given node are returned but node v.
	 *
	 * @param pathType
