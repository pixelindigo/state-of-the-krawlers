...
import com.crawljax.examples.stateabstractions.dom.RTED.PrunedRTEDUtils;
 ...
 */
public class PrunedRTEDStateVertexImpl extends StateVertexImpl {
	 ...
	 */
	public PrunedRTEDStateVertexImpl(int id, String url, String name, String dom, String strippedDom,
			double threshold) {
	...
	public double computeDistance(String dom1, String dom2) {
		...
		return PrunedRTEDUtils.getRobustTreeEditDistance(dom1, dom2);
	}

	@Override
	public boolean equals(Object object) {
		PrunedRTEDStateVertexImpl that = (PrunedRTEDStateVertexImpl) object;
	...
	public double getDist(StateVertex vertexOfGraph) {
		if (vertexOfGraph instanceof PrunedRTEDStateVertexImpl) {
			PrunedRTEDStateVertexImpl vertex = (PrunedRTEDStateVertexImpl) vertexOfGraph;
