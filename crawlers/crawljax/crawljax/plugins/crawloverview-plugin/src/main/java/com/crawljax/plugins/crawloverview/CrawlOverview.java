...
public class CrawlOverview
    ...
    private boolean arachnariumScreenshotsToggle = true;
    private boolean copySkeleton = true;
    ...
    public CrawlOverview(boolean saveScreenshots, boolean copySkeleton) {
        outModelCache = new OutPutModelCache();
        visitedStates = Maps.newConcurrentMap();
        LOG.info("Initialized the Crawl overview plugin");
        this.hostInterface = null;
        this.arachnariumScreenshotsToggle = saveScreenshots;
        this.copySkeleton = copySkeleton;
    }
    ...
    public void preCrawling(CrawljaxConfiguration config) throws RuntimeException {
        ...
        outputBuilder = new OutputBuilder(outputFolder, copySkeleton);
    }
    ...
    private void saveScreenshot(EmbeddedBrowser browser, String name, StateVertex vertex) {
        ...
        if (firstState) {
            ...
            if (!screenshotsFolder.exists()) {
                ...
                shouldTakeScreenshots = arachnariumScreenshotsToggle;
