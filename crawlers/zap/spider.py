...
def main(argv):
    ...
    try:
        ...
        if cookies_file is not None:
            ...
            zap.httpsessions.create_empty_session(target, "session")
            for k,v in cookies.items():
                zap.httpsessions.add_session_token(target, k)
                zap.httpsessions.set_session_token_value(target, "session", k, v)
            zap.httpsessions.set_active_session(target, "session")
