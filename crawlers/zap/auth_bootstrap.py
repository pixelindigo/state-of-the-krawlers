...
if __name__ == '__main__':
    ...
    s.headers.update({'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:105.0) Gecko/20100101 Firefox/105.0'})
    app = sys.argv[1] 
    ...
    with open('cookies.json', 'w') as f:
        json.dump({k:v for k,v in s.cookies.iteritems()}, f)

    print(s.cookies)
    print('cookies collected, launching the crawler')
    subprocess.run(['python3', 'spider.py'] + sys.argv[2:])
